                ...
                <form id="form-student" onSubmit={handleSubmit}>
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td colSpan="2">
                                    <input type="text" id="profilePicture" data-testid="profilePicture" name="profilePicture" onChange={handleChange}
                                        value={studentForm.profilePicture} />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colSpan="2">
                                    <Button type="submit"colorScheme="orange" variant="outline" id="add-btn" value="Add student" data-testid="add-btn">Add Student</Button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
